                ...
                <div class="order">
                    ...
                    <form class="create__inputs" action="{{route('abouts.update', $about[0]->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xs-12 mt-5 col-sm-12 col-md-12 uzb-intput">
                            ...
                            <textarea id="mytextarea" name="info_en" value="{{ $about[0]->info_en }}">{{ old('info_en') ? old('info_en') : $about[0]->info_en }}</textarea>
                        </div>

                        <div class="col-xs-12 mt-5 col-sm-12 col-md-12 uzb-intput">
                            <label for="mytextarea1">Uzbek</label>
                            <textarea id="mytextarea1" name="info_uz" value="{{ $about[0]->info_uz }}">{{ old('info_uz') ? old('info_uz') : $about[0]->info_uz }}</textarea>
                        </div>
